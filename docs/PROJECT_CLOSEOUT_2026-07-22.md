...
本次結案時，正式穩定基線為 **v6.5.0（ADB 方案）**；後續新增的第三頁設定功能已編為 **v6.6.0**。手機已安裝 `versionName=6.6.0`、`versionCode=660`，PC 端 Bridge 已可透過 ADB 運作。ADB 仍是目前這台舊手機最可靠、資源最節省的使用方式。
